...
# Form implementation generated from reading ui file 'logisticresultsdialog.ui'
#
...
class LR_results(object):
    def setupUi(self, logistic):
        ...
        self.predictionreport.setPixmap(QtGui.QPixmap("G:/B.tech Project/logisticresult.png"))
